"""
Django settings for sgitt project.
...
SECRET_KEY = 'django-insecure-7yeh^nzw9qo-2l1as0+c0$n36w(=@3!0kj2j@dri#3x(aeauni'
...
WSGI_APPLICATION = 'sgitt.wsgi.application'
